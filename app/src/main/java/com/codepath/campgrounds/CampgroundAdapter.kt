...
class CampgroundAdapter(private val context: Context, private val campgrounds: List<Campground>) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        private val nameTV = itemView.findViewById<TextView>(R.id.campgroundName)
        private val descrTV = itemView.findViewById<TextView>(R.id.campgroundDescription)
        private val locTV = itemView.findViewById<TextView>(R.id.campgroundLocation)
        ...
        fun bind(campground: Campground) {
            ...
            descrTV.text = campground.description
            locTV.text = campground.latLong
